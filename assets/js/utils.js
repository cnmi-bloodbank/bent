(function () {
  ...
  function friendlyError(error) {
    ...
    const map = [
      ...
      ['ACCOUNT_NOT_ACTIVE', 'บัญชีนี้ยังไม่พร้อมใช้งาน กรุณาติดต่อ System Admin'],
      ['SYSTEM_ADMIN_REQUIRED', 'เฉพาะ System Admin เท่านั้นที่ทำรายการนี้ได้'],
      ...
      ['EMAIL_ALREADY_HAS_ACCOUNT', 'อีเมลนี้มีบัญชี Active อยู่แล้ว ให้ใช้เมนูผู้ใช้งานหรือส่งลิงก์ตั้งรหัสผ่านใหม่'],
